...
def get_dataset(tfrecord_path, label_map='label_map.pbtxt'):
    ...
    input_config.num_prefetch_batches = 100
...
def get_dataset_multi(tfrecord_paths, label_map='label_map.pbtxt'):
    """
    Opens a tf record file and create tf dataset
    args:
      - tfrecord_path [str]: path to a tf record file
    ...
    input_config.tf_record_input_reader.input_path[:] = tfrecord_paths
